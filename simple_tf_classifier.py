...
class CSV_Image_Semantic_Dataset_Deployer(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for index, row in df.iterrows():
            ...
            pred = (torch.argmax(model([x, vector]), dim=1)).cpu().numpy().astype(bool)
        ...
        num_rows = len(df)
        return csv_file, num_true_label, num_rows
...
if __name__ == "__main__":
    ...
    if train_model:
        ...
        for batch in deploy_loader:
            ...
            print('Processed label : ', batch[2], 'True labels : ', batch[1])