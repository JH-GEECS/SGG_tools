...
class CSV_Image_Semantic_Dataset_Deployer(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_path_raw = csv_file.split('\\')[-1].split('.')[0]
        ...
        # df.loc[(df['semantic'] == True) & (df['confidence'] < 0.99), 'semantic'] = False
...
if __name__ == "__main__":
    dict_path = r'Z:\assistant\assistant_deploy'
    random_seed = 777
    dataset_path = r'Z:\assistant\assistant_deploy'
    train_size = 0.8
    lr = 1e-5
    train_model = False
    ...
    if train_model:
        ...
        full_dataset = CSV_Image_Semantic_Dataset(root_dir=dataset_path, data_sub_dir=['image_processed',
                                                                                       'image_depth',
                                                                                       'cvs_parsed_1'])
